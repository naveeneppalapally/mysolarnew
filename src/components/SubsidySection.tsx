  ...
  return (
    <section id="subsidy" className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-solar-gold opacity-[0.015] rounded-full blur-[120px]" />
        <div className="absolute bottom-0 left-1/3 w-[400px] h-[400px] bg-solar-purple opacity-[0.015] rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <div className="solar-panel-card solar-panel-card-gold p-6 sm:p-8">
              ...
              <div className="mb-6">
                ...
                <p className="text-4xl sm:text-5xl font-bold font-heading text-solar-gold">
                  ₹78,000
                </p>
              </div>
          ...
          >
            {/* Purple top border */}
            <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-solar-purple to-transparent" />

            <div className="solar-panel-card solar-panel-card-sky p-6 sm:p-8">
              {/* Corner brackets */}
              <span className="solar-panel-card-corner solar-panel-card-corner-tl" />
              <span className="solar-panel-card-corner solar-panel-card-corner-tr" />
              <span className="solar-panel-card-corner solar-panel-card-corner-bl" />
              ...
              <div className="flex items-start justify-between mb-6">
                <div 
                  ...
                  style={{ background: 'linear-gradient(135deg, rgba(var(--solar-purple-rgb), 0.2), rgba(var(--solar-indigo-rgb), 0.1))', borderColor: 'rgba(var(--solar-purple-rgb), 0.2)' }}
                >
                  <Building2 className="w-6 h-6 text-solar-purple" />
                </div>
                <span className="text-[10px] sm:text-xs font-semibold tracking-wider uppercase text-solar-purple bg-solar-purple-10 px-3 py-1.5 rounded-full border border-solar-purple-20 font-body">
                  Direct Credit
                </span>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-solar-card border border-solar-border">
                  <ArrowDown className="w-4 h-4 text-solar-purple shrink-0" />
                  <span className="text-sm text-solar-text-muted font-body">
                    Disbursed directly after net meter commissioning
                  </span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-solar-card border border-solar-border">
                  <IndianRupee className="w-4 h-4 text-solar-purple shrink-0" />
                  <span className="text-sm text-solar-text-muted font-body">
                    Aadhaar-linked Direct Benefit Transfer (DBT)
                  </span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-solar-card border border-solar-border">
                  <Sparkles className="w-4 h-4 text-solar-purple shrink-0" />
                  <span className="text-sm text-solar-text-muted font-body">
        ...
        <motion.div
          ...
          className="relative rounded-2xl overflow-hidden border border-solar-border bg-solar-bg-secondary"
        >
          <div className="relative p-6 sm:p-8 lg:p-10 text-center">
             {/* Ambient glow */}
             <div className="absolute inset-0 pointer-events-none">
               <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[150px] bg-solar-gold opacity-[0.015] rounded-full blur-[80px]" />
             </div>
            ...
            <div className="relative">
              ...
              <p className="text-5xl sm:text-6xl lg:text-7xl font-bold font-heading text-solar-text mb-4 tabular-nums">
