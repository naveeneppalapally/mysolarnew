  ...
  return (
    <section id="subsidy" className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 left-1/3 w-[400px] h-[400px] bg-sky-500/[0.015] rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <div className="solar-panel-card solar-panel-card-sky p-6 sm:p-8">
              ...
              {/* Icon + Badge */}
              <div className="flex items-start justify-between mb-6">
                <div className="w-14 h-14 rounded-xl flex items-center justify-center bg-gradient-to-br from-sky-500/20 to-sky-600/10 border border-sky-500/20">
                  <Building2 className="w-6 h-6 text-sky-400" />
                </div>
                <span className="text-[10px] sm:text-xs font-semibold tracking-wider uppercase text-sky-400/80 bg-sky-400/10 px-3 py-1.5 rounded-full border border-sky-400/15 font-body">
                  Direct Credit
                </span>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-solar-card border border-solar-border">
                  <IndianRupee className="w-4 h-4 text-sky-400 shrink-0" />
                  <span className="text-sm text-solar-text-muted font-body">
        ...
        >
          ...
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-amber-500/20 via-sky-500/20 to-amber-500/20 p-px">
