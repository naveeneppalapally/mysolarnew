      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
          ...
          <motion.div variants={fadeInUp}>
            ...
            {/* Tagline Telugu */}
            <p className="text-solar-gold text-sm leading-relaxed mb-5" style={{ fontFamily: "'Noto Sans Telugu', sans-serif" }}>
            ...
            <div className="flex gap-3 mt-4">
              ...
              >
                {/* Facebook SVG */}
                <svg className="w-4 h-4" fill="#F5A623" viewBox="0 0 24 24" aria-hidden="true">
