        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-8 items-center text-left">
          <div className="lg:col-span-7 space-y-6">
            <motion.span
              ...
              className="inline-block text-xs font-semibold tracking-[0.3em] uppercase text-emerald-400 font-body"
            >
              C&I Solar Solutions
            </motion.span>
            <motion.h1
          ...
          <div className="lg:col-span-5 relative mt-6 lg:mt-0 flex justify-center">
            ...
            >
              <img 
                src="/commercial_hero.png" 
                alt="Solar Powered Commercial Facility"
              ...
              <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center text-[10px] text-white/90 bg-gray-950/50 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/10 font-body">
                <span className="font-semibold">Turnkey C&I Installation</span>
                <span className="text-emerald-400 font-bold">40% AD Benefit</span>
              </div>
            </motion.div>
          </div>
        </div>
