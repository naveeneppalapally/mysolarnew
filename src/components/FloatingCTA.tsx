        ...
        >
          ...
          >
            ...
            <span
              ...
              style={{ background: 'radial-gradient(circle, #25D36640, transparent 70%)' }}
            />

            <motion.div
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.95 }}
              className="relative w-14 h-14 rounded-full flex items-center justify-center shadow-lg shadow-green-500/20 cursor-pointer"
